  ...
  <header className='header'>
   <div className={`mobile-menu ${showMenu ? 'open' : ''}`}>
    ...
    <button className='close-button' onClick={() => setShowMenu(false)}>
      ...
      >
       <path
        d='M32 10.4171L29.5829 8L20 17.5829L10.4171 8L8 10.4171L17.5829 20L8 29.5829L10.4171 32L20 22.4171L29.5829 32L32 29.5829L22.4171 20L32 10.4171Z'
        fill='#134178'
       />
      </svg>
     </button>
   ...
   <div className='header-content container '>
    ...
    {!showMenu && <button className='menu-header-button' onClick={() => setShowMenu(true)}>
      <svg
       width='35'
       height='25'
       viewBox='0 0 35 25'
       ...
       xmlns='http://www.w3.org/2000/svg'
      >
       <rect x='4' y='18' width='28' height='3.2' rx='1.6' fill='#134178' />
       <rect x='4' y='11' width='28' height='3.2' rx='1.6' fill='#134178' />
       <rect x='4' y='4' width='28' height='3.2' rx='1.6' fill='#134178' />
      </svg>
     </button>}
    </div>
   </div>
